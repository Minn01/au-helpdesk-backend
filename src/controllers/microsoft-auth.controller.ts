  ...
  callback: (async (request, response) => {
    try {
      ...
      if (providerError)
        throw new HttpError(
          401,
          "MICROSOFT_AUTH_REJECTED",
          "Microsoft authentication was not completed",
        );
      ...
      setSessionCookie(
        response,
        dependencies.sessions.createToken(user.id),
